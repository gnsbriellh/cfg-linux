...
## Creating User Folders ##
    ...
    # User (Non-Root) #
        mkdir   ~/Games/Libraries/Steam/    -p -v
        mkdir   ~/Games/Modding/            -p -v
        
        mkdir   ~/RDP/
        cp $PWD/RDP/xfreerdp.sh             ~/RDP/

        mkdir   ~/Projects/                 -p -v
        
        mkdir   ~/Media/Music/Spotify/      -p -v
        mkdir   ~/Media/Pictures/           -p -v
        mkdir   ~/Media/Videos              -p -v
...
## Softwares ##
    ...
    # Pacman #
        ...
        sudo pacman -S xfreerdp                     --noconfirm # Remote Desktop Cliente (No GUI);
...
## Prompt to Install .bashrc and .bash_aliases ##
